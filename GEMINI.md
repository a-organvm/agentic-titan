...
`orchestration-start-here`, `petasum-super-petasum`, `universal-node-network`, `.github`, `agent--claude-smith`, `a-i--skills`, `tool-interaction-design`, `system-governance-framework`, `reverse-engine-recursive-run`, `collective-persona-operations`
...
**UID:** `ent_repo_01KKKX3RVPV2C3YVZ518XBHS9W` | **Matched by:** primary_name

Resolve: `organvm ontologia resolve agentic-titan` | History: `organvm ontologia history ent_repo_01KKKX3RVPV2C3YVZ518XBHS9W`
